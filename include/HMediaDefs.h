...
#ifndef __H_MEDIADEFS_H__
#define __H_MEDIADEFS_H__
...
const char *MEDIA_MIMETYPE_AUDIO_ATRAC3 = "audio/atrac3";
const char *MEDIA_MIMETYPE_CONTAINER_VOB = "video/mpeg";
const char *MEDIA_MIMETYPE_CONTAINER_VC1 = "video/vc1";
const char *MEDIA_MIMETYPE_CONTAINER_HEVC = "video/hevc";
const char *MEDIA_MIMETYPE_CONTAINER_ASF1 = "video/x-ms-asf";
const char *MEDIA_MIMETYPE_AUDIO_DTS1 = "audio/dts";
}  // namespace android


#endif /* __H_MEDIADEFS_H__ */
